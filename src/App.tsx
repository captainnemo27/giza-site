...
export default function Home() {
  ...
  const isHome = route === "/";
  const isPage = (page: string) => isHome || route.startsWith(`/${page}`);
  const aboutTab = route.split("/")[2] || "company";

  return (
    <main>
      <header className="site-header">
        <a className="brand" href="#/" aria-label="Giza Digital home">
      ...
      {isPage("about") && <section className="manifesto" id="about">
        ...
        {!isHome && <div className="about-tabs" aria-label="About Us sections">
          <a className={aboutTab === "company" ? "active" : ""} href="#/about/company">Company</a>
          <a className={aboutTab === "mission" ? "active" : ""} href="#/about/mission">Our Mission</a>
          <a className={aboutTab === "strategy" ? "active" : ""} href="#/about/strategy">Our Strategy</a>
        </div>}

        {(isHome || aboutTab === "company") && <div className="about-story">
        ...
        {(isHome || aboutTab === "mission") && <div className="about-block about-mission">
        ...
        {(isHome || aboutTab === "strategy") && <div className="about-strategy">
      ...
      {isPage("services") && <section className="services" id="services">
      ...
      {isPage("work") && <section className="work" id="work">
      ...
      {isHome && <section className="testimonials">
      ...
      {isHome && <section className="faq" id="faq">
      ...
      {isPage("contact") && <section className="final-cta" id="contact">
      ...
      <footer>
        <div className="footer-main">
          <div><a className="brand footer-brand" href="#/"><img className="footer-logo" src={asset("giza-logo.png")} alt="Giza Digital" /></a><p>Data–AI systems built from deep understanding.</p></div>
          <div><span>Navigate</span><a href="#/services">Services</a><a href="#/work">Selected work</a><a href="#/about">About Us</a><a href="#/contact">Contact Us</a><a href="#/">Home</a></div>
        ...
        <div className="footer-bottom"><span>© 2026 GIZA DIGITAL SERVICES COMPANY LIMITED</span><a href="#/">BACK TO HOME ↑</a></div>
      </footer>
    </main>
  );
}
